...
/* global mina:false, Snap:false */

/**
 * @ngdoc directive
 * @name yellowFlyersApp.directive:buttonBounce
 * @description
 * # buttonBounce
 */
angular.module('yellowFlyersApp').directive('buttonBounce', function () {
	...
	var link = function(){
		(function() {
			...
			SVGButton.prototype.init = function() {
				...
				var s = new Snap( this.shapeEl.querySelector( 'svg' ) );
	...
	return {
		restrict: 'EA',
		link: link,
		templateUrl: 'views/_button.html'
	};
});
